...
namespace Drupal\tide_content_collection\Controller;
 ...
 */
class UrlAutoCompleteController extends ControllerBase {
  ...
  public function handleAutocomplete(Request $request) {
    ...
    foreach ($nodes as $node) {
      if ($node->isPublished()) {
        $results[] = [
          'value' => $node->toUrl('canonical', ['absolute' => TRUE])->toString(),
          'label' => $node->getTitle(),
        ];
      }
    }
